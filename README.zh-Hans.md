...
<p align="center"><strong>面向开发、审查、证据与私有远程工作的 local-first 可审计多 Agent 控制室。</strong></p>

<p align="center">
  让 Codex、Claude Code、Grok、Kimi、供应商 API、OpenAI-compatible endpoint 与本地模型
  在桌面和手机组成受治理的工程团队，同时保留各自的原生能力。
</p>
...
<p align="center">
  <a href="https://github.com/Hoylon/peerbridge-mcp/releases/tag/v0.1.0-alpha.6"><img src="https://img.shields.io/badge/release-v0.1.0--alpha.6-2563eb" alt="PeerBridge Alpha 6 发布"></a>
...
<p align="center">
  <a href="https://github.com/Hoylon/peerbridge-mcp/releases/tag/v0.1.0-alpha.6"><strong>下载 Windows Alpha</strong></a>
...
1. 从 [Alpha 6 Release](https://github.com/Hoylon/peerbridge-mcp/releases/tag/v0.1.0-alpha.6)
   下载 `PeerBridgeControlRoom-0.1.0a6-windows-x64-portable.zip`。
