...
<p align="center">
  <a href="https://github.com/Hoylon/peerbridge-mcp/releases/tag/v0.1.0-alpha.5.5"><img src="https://img.shields.io/badge/release-v0.1.0--alpha.5.5-2563eb" alt="PeerBridge Alpha 5.5 发布"></a>
...
<p align="center">
  <a href="https://github.com/Hoylon/peerbridge-mcp/releases/tag/v0.1.0-alpha.5.5"><strong>下载 Windows Alpha</strong></a>
...
1. 从 [Alpha 5.5 Release](https://github.com/Hoylon/peerbridge-mcp/releases/tag/v0.1.0-alpha.5.5)
   下载 `PeerBridgeControlRoom-0.1.0a5.post5-windows-x64-portable.zip`。
...
从 GitHub Release 下载
`PeerBridgeControlRoom-0.1.0a5.post5-windows-x64-portable.zip`，核对同页 SHA-256，
